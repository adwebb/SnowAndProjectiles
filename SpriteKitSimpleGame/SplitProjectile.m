...
+(SplitProjectile*)splitProjectileOfRank:(int)rank
{
    ...
    for (NSInteger i = 0; i < rank + 1; i++) {
        ...
        CGFloat xOffset = i % 2 == 0 ? 0 : 10;
        CGFloat yOffset = i < 2 ? -10 : 10;
        
        splitProjectile4.position = CGPointMake(parentProjectile.position.x + xOffset, parentProjectile.position.y + yOffset);
        
        NSLog(@"Child Projectile %d: Position %@", i, NSStringFromCGPoint(splitProjectile4.position));
